    ...
    <>
      <section className="page-head" data-screen-label="Services">
        <div className="wrap">
          ...
          <p className="page-lead">Genmars Tech designs and builds software for businesses, developers, agencies, and startups. Whether you need an end-to-end product, a specific integration, or a technical partner — this is what we do.</p>
          <div className="hero-cta" style={{ marginTop: "clamp(24px,3vw,36px)" }}>
            ...
            <Link className="btn btn-ghost" href="/about">About Genmars Tech</Link>
          </div>
        </div>
      </section>
