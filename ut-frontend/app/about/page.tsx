...
export const metadata: Metadata = {
  title: "About",
  description: "Genmars Tech · UrbanTrends — a software studio from Nairobi building products, tools, and applications for the businesses and developers we live alongside.",
};

const METRICS = [
  { n: "2026", l: "Founded in Nairobi" },
  { n: "5+", l: "Products & tools shipped" },
  { n: "2", l: "Official team members" },
  { n: "BN-93S95J2J", l: "Registration number" },
];

const TEAM = [
  { initials: "EW", name: "Edwin Wamuyu",  role: "Founder · CEO",        bio: "Started Urbantrends.dev to build software that actually works in this market." },
  { initials: "EN", name: "Eric Njeru",    role: "Co-founder · CTO",     bio: "Owns the technical infrastructure and product engineering." },
];

const COLLABORATORS = [
  {
    label: "Businesses",
    desc: "SMEs and enterprises needing custom software, M-Pesa integrations, and automation that survives real-world conditions.",
    icon: "M3 21h18M5 21V7l7-4 7 4v14",
    color: "#34D399",
    img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80",
    imgAlt: "Modern business office building in Nairobi",
  },
  {
    label: "Developers",
    desc: "Engineers who build on our APIs, SDKs, and open-source Daraja tooling — without reinventing the callback wheel.",
  ...
  {
    label: "Agencies",
    desc: "Design and dev agencies that bring us in for payment rails, backend systems, and the integrations they don't want to own.",
    ...
    imgAlt: "Creative agency team collaborating around a table",
  },
  {
    label: "Startups",
    desc: "Early-stage founders who need a technical co-builder — not just a contractor — who cares whether the thing ships.",
  ...
  },
  {
    ...
    icon: "M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0M4.5 12H3m16.5 0H21m-9 9v-1.5m0-15V3",
    color: "#34D399",
    img: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&w=800&q=80",
    imgAlt: "Community volunteers working together on a project",
  },
];
    ...
    <>
      <section className="page-head" data-screen-label="About">
        <div className="wrap">
          ...
          <p className="page-lead">UrbanTrends is the product brand of <strong>Genmars Tech</strong> — a software studio that designs and builds products, tools, and applications for the businesses and developers we live alongside. We work with startups, agencies, companies, and NGOs across East Africa and beyond.</p>
        </div>
      </section>
      ...
      <section className="section" style={{ paddingTop: "clamp(20px,3vw,36px)" }}>
        <div className="wrap">
          <div className="metrics">
            {METRICS.map((m) => (
              <div key={m.l} className="m"><div className="n">{m.n}</div><div className="l">{m.l}</div></div>
            ))}
          </div>
        </div>
      </section>

      {/* ── ABOUT ILLUSTRATION (where a real team/office photo would go) ── */}
      {/* <section className="section" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="about-photo-band">
            <Image
              src="https://images.unsplash.com/photo-1583250544045-31e113d013a3?auto=format&fit=crop&w=1400&q=80"
              alt="Software developers collaborating in a modern African tech office"
              width={1400}
              height={500}
            ...
            <div className="about-photo-caption">
              Genmars Tech office, Nairobi — where every product starts as a whiteboard sketch.
            </div>
          </div>
        </div>
      </section> */}
      ...
      <section className="section divider-top">
        <div className="wrap split lead">
          <div>
            <span className="eyebrow muted">Why Genmars Tech</span>
            <h2 className="page-title" style={{ fontSize: "clamp(26px,3.4vw,38px)", maxWidth: "18ch" }}>We build for the market we live in.</h2>
            <p className="page-lead" style={{ fontSize: 17 }}>Every product we ship has to survive contact with a real operator on a bad-network Tuesday. That constraint is a gift. It forces us to handle the edge cases that generic software ignores — Paybill quirks, settlement timing, compliance formats, intermittent connectivity.</p>
            <p className="page-lead" style={{ fontSize: 17, marginTop: 18 }}>UrbanTrends is the public face of what we build. Behind it is Genmars Tech — a studio that also works directly with businesses, developers, and agencies on custom software, integrations, and tools.</p>
          </div>
          <div className="code-window">
            <div className="code-bar"><div className="tl"><i></i><i></i><i></i></div><span className="fname">principles.md</span><span className="lang">Genmars Tech</span></div>
      ...
      <section className="section divider-top">
        <div className="wrap">
          ...
          <div className="team-grid">
            {TEAM.map((m) => (
              <div key={m.initials} className="member">
        ...
        <div className="wrap">
          ...
          <div className="reg-card">
            ...
            <dl className="reg-dl">
              ...
              {/* <div className="reg-row"><dt>Registered Proprietor</dt><dd>EDWIN MUCHEMI WAMUYU</dd></div> */}
      ...
      <section className="cta-band">
        <div className="wrap cta-inner">
          ...
          <div className="hero-cta" style={{ margin: 0 }}>
            ...
            <Link className="btn btn-ghost" href="/careers">Join the team</Link>
          </div>
        </div>
      </section>
    </>
